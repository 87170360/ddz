#ifndef _PARTY_CLIENT_H_
#define _PARTY_CLIENT_H_
...
class PartyClient
{
	...
	public:
		typedef void (*ReciveCmdFunc)(PartyClient* client,void* data,Jpacket& packet);
		typedef void (*CloseFunc)(PartyClient* client,void* data);
	...
	public:
		PartyClient(struct ev_loop* loop);
		~PartyClient();
