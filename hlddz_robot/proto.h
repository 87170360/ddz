...
enum SERVER_COMMAND
{
    ...
    SERVER_AGAIN_CALL           = 2003,         //通知下一个叫分: 上次叫分:score, 当前操作者id:cur_id,上一个操作者id:pre_id, 叫分倒计时:time, 倍数:count
    SERVER_RESULT_CALL          = 2004,         //叫分结果,开始加倍： 最终分数:score, 地主id:lord, 加倍倒计时:time, 3底牌:card, 倍数:count 
