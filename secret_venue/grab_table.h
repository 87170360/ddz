#ifndef _GRAB_TABLE_H_
#define _GRAB_TABLE_H_
...
public:
	...
	int                    lose_exp;     ///输的经验值
	int                    win_exp;      ///赢的经验值
	EnGrabGameState			   game_state;   // game state(即游戏场景)
	...
	GrabSeat                   seats[MAX_CHAIR_COUNT]; // 坐位数组(一张桌子5个位置)
...
//private:
	...
	//更新玩家历史最好牌
	void update_best_board(GrabSeat &seat);
